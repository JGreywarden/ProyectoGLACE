...
const VALID_TRANSITIONS: Readonly<Record<GameState, readonly GameState[]>> = {
  ...
  [GameState.WEEK_PROCESSING]:   [GameState.WEEKLY_PLANNING, GameState.NARRATIVE_EVENT, GameState.COMPETITION, GameState.SEASON_END],
  [GameState.NARRATIVE_EVENT]:   [GameState.WEEKLY_PLANNING, GameState.SEASON_END],
  [GameState.COMPETITION]:       [GameState.WEEKLY_PLANNING, GameState.SEASON_END],
